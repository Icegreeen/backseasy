...
const getProjectMetadata = (): ProjectMetadata[] => {
  ...
  const allProjects = [...butterflyProjects, ...blackProjects, ... squareProjects, ...skyProjects, ...whiteProjects, ...animatedProjects, ...svgProjects, ...atmosphereProjects, ...objectsProjects];
