...
type: "animated"
date: "2024-04-05"
image: "https://github.com/Icegreeen/blog-graphQL/assets/56550632/b841ce8e-8c14-4f37-bc14-d4872da74785"
---
#### How to implement:
  ...
  return (
    <div className="flex flex-col items-center h-full">
        <div className={styles.container}>
			...
			<svg version="1.1" id="home-anim" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1820 1080"  xmlSpace="preserve">
				<g id="home" className={styles.home}>
					<defs>
					...
					<g id="light-blue" className={styles.lightBlue}>
					...
					<g id="blue" className={styles.blue}>
...
```
.container {
  background: linear-gradient(to right top, rgb(35, 2, 126), rgb(13, 8, 17), rgb(0, 0, 0));
  width: 100vw; 
  height: 100vh; 
  overflow: hidden;
}
...
![Captura de tela de 2024-04-12 14-57-55](https://github.com/Icegreeen/blog-graphQL/assets/56550632/d9206ae1-2a7b-42a0-9992-205abc641b04)

![Captura de tela de 2024-04-12 15-11-55](https://github.com/Icegreeen/blog-graphQL/assets/56550632/cc4aadfb-f4d3-4d26-87c1-21bd2c1bc24e)

Responsive: Mobile and desktop:

![Macbook-Air-localhost (1)](https://github.com/Icegreeen/blog-graphQL/assets/56550632/4700d36b-59de-417c-b0aa-77118c7ed96a)
