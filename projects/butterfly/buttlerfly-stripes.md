...
type: "butterfly"
date: "2024-02-18"
image: "https://github.com/Icegreeen/blog-graphQL/assets/56550632/e510f890-7140-45c5-86f8-7cb9a1ec549a"
---
...
export default function Background() {
  return (
    <>  
         <section className="relative flex flex-col items-center h-screen bg-[#000] overflow-hidden clash-grotesk">
                <svg className="absolute opacity-30" width="2321" height="1350" viewBox="0 0 1681 978" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <defs>
                    <filter id="filter0_f_1503_1700" x="-870.685" y="-896.931" width="3321.89" height="2162.05" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                      ...
                      <feGaussianBlur stdDeviation="65.0825" result="effect1_foregroundBlur_1503_1700"></feGaussianBlur>
                    </filter>
...
![Captura de tela de 2024-03-15 15-36-37](https://github.com/Icegreeen/blog-graphQL/assets/56550632/fde96b33-1c42-4a27-b892-6fcdc3a47410)

### Mobile and Desktop:

![f](https://github.com/Icegreeen/blog-graphQL/assets/56550632/470213b5-722c-4bc3-ade3-3a37d71b7eba)
