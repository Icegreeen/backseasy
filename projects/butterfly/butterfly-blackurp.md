...
type: "butterfly"
date: "2024-03-07"
image: "https://github.com/Icegreeen/blog-graphQL/assets/56550632/5d5f1699-c97c-4738-8ba6-b5e26a8e146a"
---
...
export default function Background() {
  return (
    <section className="flex overflow-hidden flex-col w-full h-screen items-center bg-gradient-to-t from-[#000] relative to-[#141521] "> 
                <svg className="absolute h-screen" fill="none" viewBox="0 0 1440 700" xmlns="http://www.w3.org/2000/svg">
...
![Captura de tela de 2024-03-07 18-02-36](https://github.com/Icegreeen/blog-graphQL/assets/56550632/c74860de-ed97-4ae0-ba04-968dd7692a4c)

### Mobile and Desktop:

![Macbook-Air-localhost (1)](https://github.com/Icegreeen/blog-graphQL/assets/56550632/95a62e06-9591-49d4-8270-f287c68a9cf5)
