...
type: "butterfly"
date: "2024-02-18"
image: "https://github.com/Icegreeen/blog-graphQL/assets/56550632/648b1d46-85b9-4b90-9040-0558f32dc684"
---
  ...
  return (
   <>
      <section className="relative h-screen overflow-hidden">
                <svg className="absolute h-screen rotate-180" fill="none" viewBox="0 0 1440 720" xmlns="http://www.w3.org/2000/svg">
                  <g clip-path="url(#clip0_106_41)">
                    ...
                    <g filter="url(#filter1_f_106_41)"  style={{mixBlendMode: `color-dodge`}}>
                    ...
                    <g filter="url(#filter3_f_106_41)"  style={{mixBlendMode: `color-dodge`}}>
                    ...
                    <g filter="url(#filter5_f_106_41)"  style={{mixBlendMode: `color-dodge`}}>
                    ...
                    <g filter="url(#filter7_f_106_41)" style={{mixBlendMode: `color-dodge`}}>
                ...
                <section  className="flex flex-col h-screen" style={{backgroundImage: `linear-gradient(180deg, #651eea, #7f2aec 43%`}}>
...
![Captura de tela de 2024-03-15 05-50-32](https://github.com/Icegreeen/blog-graphQL/assets/56550632/dd445c3c-4dc8-4ebe-b2c8-aa58400c4000)

### Mobile and Desktop:

![Macbook-Air-localhost (2) (1)](https://github.com/Icegreeen/blog-graphQL/assets/56550632/dbf19e0c-3395-4d8e-b80f-9efe8fc1021c)
