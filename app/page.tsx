...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="max-w-[1800px] w-full flex flex-col md:flex-row items-center justify-between pb-12" id="projects">
        <a href="#frosted">
        ...
        <div className="w-full md:w-auto flex flex-col md:flex-row gap-8 mt-[40px] sm:mt-[55px]">

          <div className="w-full sm:w-auto md:mx-8 inline-flex animate-shine items-center justify-center rounded-[10px] text-sm border 
          ...
          <div className="w-full sm:w-auto inline-flex animate-shine items-center justify-center rounded-[10px] text-sm border 
                  border-neutral-800 bg-[linear-gradient(110deg,#050505,45%,#1e2631,55%,#050505)] bg-[length:200%_100%] 
                  font-medium text-neutral-400 transition-colors border-stroke-1 max-w-[800px] p-8 gap-32 flex-col max-[580px]:p-32 max-[580px]:gap-24" id="projects">
